    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                '" case when dl.statusid = 12 then 'Completed/Closed' when dl.statusid = 18 then 'Completed/Closed' when dl.statusid = 19 then 'Completed/Closed' when dl.statusid = 15 then 'Completed/Closed' when dl.statusid = 8 then 'Completed/Closed' else 'Open' end as statusdesc, "
                ...
                Else
                    ...
                    s_sql = s_sql & "(isnull(u2.FirstName,u.LastName)+' '+isnull(u2.LastName,u.LastName)) AS assignedto, " & _
                               ...
                               "case when isdate(div.colvalue)=1 then convert(datetime,div.colvalue) else isnull(convert(varchar(10),dl.completeddate,101),'') end AS adate," & _
