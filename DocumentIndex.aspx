<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Report.Master" CodeBehind="DocumentIndex.aspx.vb" Inherits="dms.DocumentIndex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="DocumentIndex.rdlc">          
        ...
        <asp:SqlDataSource ID="ds1" runat="server" 
            ...
            SelectCommand="DMSP_REPORT_DOCTYPE" SelectCommandType="Text">
            <%--<SelectParameters>
                ...
                <asp:SessionParameter DefaultValue=" " Name="asColValue" 
