<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="criteria_overdue.aspx.vb" Inherits="dms.criteria_overdue" EnableEventValidation="true" %>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="MainHeaderContent">
      ...
      <tr>
                            <td><asp:Image ID="Image8" runat="server" width="20px" Height="20px" imageurl="images/task.png" />&nbsp;Overdue Tasks Report</td>
                         </tr>
    </table>    
                                ...
                                <table border="0"  cellspacing="1" cellpadding="3" width="100%" style="border:solid 1px #D4D4D4;">
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="tbAuthor" runat="server" cssclass="entryfld" AutoComplete="off"> </asp:TextBox>
