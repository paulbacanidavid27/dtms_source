<%@ Page Title="Document Inbox" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="inbox.aspx.vb" Inherits="dms.inbox" %>
    <%@ MasterType VirtualPath="~/Site.Master" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<%@ Register src="UserControlBookMark.ascx" tagname="UserControlBk" tagprefix="uc" %>    
<%@ Register src="UserControlFolder.ascx" tagname="ControlFolder" tagprefix="uc" %>    
...
<td>
    <asp:RadioButtonList ID="rbSelection" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" Font-Bold>
        <asp:ListItem Selected="False" Text="ALL" Value="A" title="List all documents that you have access. This include all the documents received by your office." ></asp:ListItem>
         <asp:ListItem Selected="True" Text="INBOX" Value="I" title="List all documents that you already received and uploaded."></asp:ListItem>
                ...
                <table border="0" width="100%">
                   <tr >
                        ...
                        <ContentTemplate>
                            ...
                            &nbsp;<asp:Label ID="lType" runat="server" Text="Inbox"></asp:Label> 
                            </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>                 
                        <td>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <!-- 01/17/2014 //-->                                                                        
     ...
     <table border="0" class="codetbl" cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse;z-index:900;border:#D4D4D4 solid 1px">
                    ...
                    <tr >
                        ...
                        <td class="newtblheader"><asp:LinkButton ID="lbSort7" runat="server" class="sortcol" tooltip="Sort by Agency" OnClick="sortColumnHeader">Point Person</asp:LinkButton><asp:Image ID="imgSort7" imageurl="images/asc.png" runat="server" visible="false" style="vertical-align:middle;"/></td>
    ...
    <asp:Repeater ID="Repeater1" visible="true" runat="server" >
            <HeaderTemplate>           
                        ...
                        <asp:ImageButton ID="imgMove" runat="server" imageurl="images/fmove.png" Width="18px" Height="18px"/>
