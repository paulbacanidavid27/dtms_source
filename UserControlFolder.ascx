<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UserControlFolder.ascx.vb" Inherits="dms.UserControlFolder" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="newtblheader2">
                            <tr height="25px">
                                <td align="center" width="30px">
                                    <asp:imagebutton runat="server" ID="imgShowInbox" onclientClick="ShowProgress(this)" imageurl="images/inbox.png" OnClick="ShowInbox" width="20px" height="20px" ToolTip="Goto Inbox"/></td>
                                    <td STYLE="color:#EEEEEE;font-family:Arial;font-size:10pt;font-weight:bold;font-style:normal;color:#CCCCCC">Inbox Folders</td>
                                    <td align="right" style="padding-right:15px"><asp:ImageButton ID="imgAddFolder"  height="16px" Width="18px" tooltip="Add Folder" runat="server"   ImageUrl="images/add.png" onclick="AddFolder"/></td>
