<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UserControlConfidential.ascx.vb" Inherits="dms.UserControlConfidential" %>
...
<asp:Panel ID="pConfidential" runat="server" cssclass="bordertask">         
                            ...
                            <tr height="25px" >
                                <td width="25px" style="border-bottom:solid 1px #D4D4D4;">
                                    <asp:Image ID="Image2" runat="server" ImageUrl="images/confi_icon.jpg" height="16px" Width="20px" />
                                </td>
                  ...
                  <%--  </div> --%>     
                    ...
                    <asp:Repeater ID="Repeater2" runat="server" visible="true" >
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                                <td colspan="8" height="5px"><%--<uc1:ucHr ID="cld" runat="server" />--%>                                   
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
