<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UserControlApproval.ascx.vb" Inherits="dms.UserControlApproval" %>
...
<asp:Panel ID="pConfidential" runat="server" cssclass="bordertask">         
                  ...
                  <%--  </div> --%>     
                    ...
                    <asp:Repeater ID="Repeater2" runat="server" visible="true" >
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                            <td colspan="8" style="padding-left:25px;margin-bottom:10px;">
                                <uc:UserControlDocRouting ID="ucDocRouting" runat="server" />
                            </td>
                            </tr>
                            <tr>
                               
                                <td colspan="8" style="padding-top:2px" align="right">
                            ...
                            <tr>
                                <td colspan="8"><asp:panel ID="pcomment" runat="server" Visible="false"> Comment: 
