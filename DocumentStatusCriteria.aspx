<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="DocumentStatusCriteria.aspx.vb" Inherits="dms.DocumentStatusCriteria" EnableEventValidation="true" %>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="MainHeaderContent">
      ...
      <tr>
                            <td><img width="20px" Height="20px" src="images/report_icon.png" /> Document Status Report</td>
                         </tr>
    </table>    
...
<ContentTemplate>
    <asp:Panel id="pRepeater" runat="server" DefaultButton="btSearch" Width="100%">  
                            ...
                            <td align="left">
                                ...
                                <table border="0"  cellspacing="1" cellpadding="3" width="100%" style="border:solid 1px #D4D4D4;">
                                    ...
                                    <td align="right" class="labelFreeForm">
                                                Classification:</td>
                                            <td align="left">                                    
                                                <asp:DropDownList ID="dlClassification" runat="server" cssclass="entryfld2" Width="350px">
