<%@ Page Title="" Language="vb" AutoEventWireup="false"  CodeBehind="viewfilelocal.aspx.vb" Inherits="dms.viewfilelocal"  EnableEventValidation="False" %>
<html>
<head></head>
...
<%--<asp:ImageButton ID="imgPrint" Width="20px" Height="20px" style="cursor:hand;padding-right:75px;" visible="true"  ToolTip="Print Document" ImageUrl="images/print2.png" runat="server" />--%>
    ...
    <asp:Literal ID="lMsg" runat="server" Visible="false" Text="test"></asp:Literal>
