...
Public Class DocSession
    ...
    Public Shared ReadOnly Property CompleteStatus As String
        ...
        End Get
    End Property
    Public Shared ReadOnly Property OnHoldStatus As String
        Get
            Dim lsCol As String = System.Configuration.ConfigurationManager.AppSettings("OnHold")
            If Not lsCol Is Nothing AndAlso lsCol <> "" Then
                Return lsCol
            Else
                Return ""
    ...
    Public Shared Property sFormID As String
        Get
            If Current IsNot Nothing AndAlso Not Current.Session("s_FormID") Is Nothing Then
                Return CStr(Current.Session("s_FormID"))
            Else
                Return ""
            End If
        End Get
        Set(ByVal value As String)
            Current.Session("s_FormID") = value
        End Set
    End Property
    ...
    Public Shared Property IsLocalDoc As String
        Get
            If Current IsNot Nothing AndAlso Not Current.Session("s_Local") Is Nothing Then
                'Return IIf(CStr(Current.Session("s_DocStatus")) = "8" OrElse CStr(Current.Session("s_DocStatus")) = "5", True, False)
                Return Current.Session("s_Local")
            Else
                Return ""
            End If
        End Get
        Set(ByVal value As String)
            Current.Session("s_Local") = value
        End Set
    End Property
    ...
    Public Shared ReadOnly Property FileLoc As String
        ...
        End Get
    End Property
    Public Shared ReadOnly Property FileLoc2 As String
        Get
            Dim lsLoc As String = System.Configuration.ConfigurationManager.AppSettings("fileloc2")
            If lsLoc.Substring(lsLoc.Trim.Length - 1, 1) <> "\" AndAlso lsLoc.Substring(lsLoc.Trim.Length - 1, 1) <> "/" Then
                lsLoc = lsLoc & "\"
            End If
            Return lsLoc
    ...
    Public Shared ReadOnly Property sSendEmail As Boolean
        ...
        End Get
    End Property
    Public Shared ReadOnly Property sSendCCEmail As Boolean
        Get
            Dim lsNoEmail As String = System.Configuration.ConfigurationManager.AppSettings("EmailCC")
            If lsNoEmail = "N" Then
                Return False
            Else
                Return True
    ...
    Public Shared ReadOnly Property sIsLocal As Boolean
        Get
            Dim lsLocal As String = System.Configuration.ConfigurationManager.AppSettings("IsLocal")
            If lsLocal = "Y" Then
                Return True
            Else
                Return False
    ...
    Public Shared ReadOnly Property LocalPath As String
        Get
            Dim lsLocal As String = System.Configuration.ConfigurationManager.AppSettings("LocalPath") '& "/" & System.Configuration.ConfigurationManager.AppSettings("virtualdir")
    ...
    Public Shared ReadOnly Property MaxFileSize As Integer
        ...
        End Get
    End Property
    Public Shared ReadOnly Property ZipMaxFileSize As Integer
        Get
            Dim liMaxFileSize As Integer = System.Configuration.ConfigurationManager.AppSettings("ZipMaxFileSize")
            Return liMaxFileSize
        End Get
    End Property
    ...
    Public Shared Property doc_DocReceived As String
        ...
        End Set
    End Property
    Public Shared Property DocAuthor As String
        'Get
    ...
    Public Shared Property DocCreated As String
        'Get
    ...
    Public Shared Property DocCreatedFrom As String
        'Get
        '    If Current IsNot Nothing AndAlso Not Current.Session("s_doc_DocCreated") Is Nothing Then
        '        Return CStr(Current.Session("s_doc_DocCreated"))
        '    Else
    ...
    Public Shared Property DocCreatedTo As String
        'Get
        '    If Current IsNot Nothing AndAlso Not Current.Session("s_doc_DocCreated") Is Nothing Then
        '        Return CStr(Current.Session("s_doc_DocCreated"))
        '    Else
    ...
    Public Shared Property DocClassification As String
        'Get
        '    If Current IsNot Nothing AndAlso Not Current.Session("s_doc_DocCreated") Is Nothing Then
        '        Return CStr(Current.Session("s_doc_DocCreated"))
        '    Else
    ...
    Public Shared Property doc_SortCol As String
        ...
        End Set
    End Property
    Public Shared Property DocTitle As String
        'Get
    ...
    Public Shared Property sOwner As Boolean
        ...
        End Set
    End Property
    Public Shared Property isEncrypted As String
        Get
            If Current IsNot Nothing AndAlso Not Current.Session("s_doc_encr") Is Nothing Then
                Return CStr(Current.Session("s_doc_encr"))
            Else
                Return ""
            End If
        End Get
