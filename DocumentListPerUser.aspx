<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Report.Master" CodeBehind="DocumentListPerUser.aspx.vb" Inherits="dms.DocumentListPerUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="DocumentListPerUser.rdlc">          
            
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="dsUserDocReceived" 
                        Name="dsUserDocReceived" />                    
                </DataSources>                
