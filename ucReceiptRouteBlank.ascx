<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReceiptRouteBlank.ascx.vb" Inherits="dms.ucReceiptRouteBlank" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <table cellspacing="0" class="popuphdr" cellpadding="0" border="0" style="width: 100%">
                                    <tr height="30px">
                                        <td align="left" valign="middle" colspan="2">&nbsp;<img height="20px" width="18px" src="images/print.png" />&nbsp;Print Additional Route Slip</td>
                            ...
                            <td align="center">
                                <asp:Panel ID="ackreceipt" runat="server" Visible="true" Style="width: 99%; overflow: auto; max-height: 500px;">
                                    ...
                                    <table id="printArea" style="background-image: url('images/logo/watermark.png'); background-repeat: no-repeat; background-position: center; height: 100%; width: 100%; font-family: Arial; font-size: 11pt">
                                       ...
                                       <tr>
                                           <td colspan="4" style="font-size:7pt;" align="right"><i>Additional page</i></td>
                                       </tr>
                                    </table>
                                </asp:Panel>
                            </td>
