...
Public Class viewfilelocal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim lsOwner As String = Request.QueryString("o")
            Dim lsCanDownload As String = Request.QueryString("d")
            Dim lSRole As String = Request.QueryString("r")
            Dim lUsr As String = Request.QueryString("u")
            ...
            If lsOwner = "1" OrElse lsCanDownload = "1" OrElse lsRole = "A" Then
            ...
            Else
                ...
                If lsId <> "" Then
                    RetrieveDoc(lsId, lsVno, lsRefNo)
                Else
    ...
    Private Sub RetrieveDoc(ByVal asId As String, ByVal asVno As String, ByVal sRefNo As String)
        'Dim lsLoc As String = System.Configuration.ConfigurationManager.AppSettings("fileloc")
        Dim oDocs As New DocList
        ...
        Try
            ...
            If lodata.Rows.Count > 0 Then
                ...
                DocSession.sCurrentFile = sYear & "\" & sMonth & "\" & sRefNo & "\" & asId & "_" & asVno & "_" & lodata(0).Item("FileName")
