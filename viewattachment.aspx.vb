...
Public Class viewattachment
    ...
    Private Sub RetrieveDoc(ByVal asId As String, ByVal asVno As String)
        ...
        Try
            ...
            ElseIf Not System.IO.File.Exists(DocSession.FileLoc2 & DocSession.sCurrentFile) Then
                DocSession.sCurrentFile = asId & "_" & asVno & "_" & lodata(0).Item("FileName")
    ...
    Private Function getCurrentFile() As String
        Dim lsPath As String = DocSession.FileLoc & DocSession.sCurrentFile
        If Not System.IO.File.Exists(lsPath) Then
            lsPath = DocSession.FileLoc2 & DocSession.sCurrentFile
        End If
        Return lsPath
    End Function
    Private Sub Dfile()
