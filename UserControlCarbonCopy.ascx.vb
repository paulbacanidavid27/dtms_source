Public Class UserControlCarbonCopy
...
#End Region
    ...
    Private Sub RetrieveApproval()
        ...
        Try
            ...
            lsTotalRows = oApprove.CountPendingCarbonCopy
            oApprove.pSortCol = hfSortCol.Value
            oApprove.pSortOrder = hfSortOrder.Value
            ldata = oApprove.RetrievePendingCarbonCopy
            ...
            If ldata.Rows.Count = 0 Then
                ...
                'pPager.Update()
                pCarbonCopy.Visible = False
            Else
                pCarbonCopy.Visible = True
