<%@ Page Title="Request Type" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="DocRequestType.aspx.vb" Inherits="dms.DocRequestType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Request Type Maintenance</title>
</asp:Content>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainHeaderContent">
        ...
        <tr >
            <td class="hdrtitle_1" > <img  alt="" src="images/docrequest.png" style="vertical-align:middle" Width="20px" height="20px"/>&nbsp;Request Type</td>
            <td align="right">
...
<asp:Content ID="mContent" runat="server" ContentPlaceHolderID="menuContent">
                            ...
                            <uc:ucButton id="ucAdd" runat="server" pText="Add Request Type" pImage="images/group2.png"></uc:ucButton>
                            <asp:UpdatePanel ID="pnlFilter" runat="server" UpdateMode="Conditional">
                                ...
                                <td align="left" class="labelFreeForm">
                                    Description:</td>
                                <td align="left">
                                    <asp:TextBox ID="tbSearchDesc"  MaxLength="200" CssClass="entryfld" runat="server"></asp:TextBox>
                                </td>
                                <td align="left">
                                    &nbsp;</td>
                                <td align="left">
           ...
           <table border="0" class="codetbl" cellspacing="0" cellpadding="0" style="border-collapse:collapse;width:100%;z-index:900;border:solid 1px #D4D4D4">
                    <tr >
                        ...
                        <td class="newtblheader">
                            <asp:LinkButton ID="lbSort1" runat="server" class="sortcol" tooltip="Sort by Document Status" OnClick="sortColumnHeader">Request Type</asp:LinkButton>
                            <asp:Image ID="imgSort1" imageurl="images/asc.png" runat="server" visible="true"/>
                        </td>                        
                        <td class="newtblheader">Office</td>
                        <td class="newtblheader">Age Calculation</td>
            ...
            <ItemTemplate>                
                    <tr>
                            ...
                            <td>
                                ...
                                <asp:Literal ID="lReceiptDesc" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "RequestDescription"))%>'></asp:Literal>                            
                                <asp:Literal ID="lReceiptID" visible="false" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "RequestType"))%>'></asp:Literal>
                            </td>           
                            <td>
                                <asp:Literal ID="lOffice" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "Office"))%>'></asp:Literal>                            
                                
                            </td>     
                            <td>
                                <asp:Literal ID="Literal1" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "AgeCalcDesc"))%>'></asp:Literal>                            
                                <asp:Literal ID="lAgeCalc" runat="server" visible="false" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "AgeCalc"))%>'></asp:Literal>                            
                            </td>              
                            <td  align="center">
                    ...
                    <tr>
                        <td colspan="4" class="tbldashed"></td>
                    </tr>
            </ItemTemplate>
            <FooterTemplate>
                    <tr>
                                    ...
                                    <table cellspacing="0" class="popuphdr" cellpadding="0" border="0" style="width:100%">
                                        <tr height="30px">
                                            <td align="left" valign="middle" colspan="2">
                                                &nbsp;<img height="25px" width="20px" src="images/group.png" />&nbsp;Request Type - 
                                        ...
                                        <table width="100%" border="0">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <asp:TextBox ID="tbDesc" class="entryfld" MaxLength="200" Width="350px" runat="server"></asp:TextBox>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                    * Office:</td>
                                                <td align="left">
                                                    <asp:Literal ID="ltOffice" runat="server" Visible="false"></asp:Literal>
                                                    <asp:DropDownList ID="dlOffice" runat="server">
                                                        <asp:ListItem Text="DBM" Value="DBM"></asp:ListItem>
                                                        <asp:ListItem Text="PS" Value="PS"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <asp:DropDownList ID="dlAgeCalc" runat="server">
                        ...
                        <tr>
                            <td align="center">
                                <table cellspacing="0" class="popuphdr" cellpadding="0" border="0" style="width:100%">
                                    <tr height="30px">
                                        <td align="left" valign="middle" colspan="2">
                                            &nbsp;<img height="25px" width="20px" src="images/group.png" />&nbsp;Request Type - Delete</td>
                                        <td  align="right" valign="top">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;background-color:White;width:100%;border:solid 1px #D4D4D4">
                                    <asp:Repeater ID="Repeater2" visible="true" runat="server" >
                                        <HeaderTemplate>
                                            ...
                                            <tr>
                                                <td class="newtblheader">
                                                    Request Type</td><td class="newtblheader">Comments</td>
                                        ...
                                        <ItemTemplate>
                                            <tr  id="rw" runat="server" height="20px">
                                                <td class="tbldashed">
                                                    <asp:Literal ID="lDesc" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "RequestDescription"))%>'></asp:Literal>
                                                    <asp:Literal ID="lID" runat="server" visible="false" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "RequestType"))%>'></asp:Literal>
                                                </td>
                                                <td class="tbldashed">
