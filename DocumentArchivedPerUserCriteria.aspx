<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="DocumentArchivedPerUserCriteria.aspx.vb" Inherits="dms.DocumentArchivedPerUserCriteria" EnableEventValidation="true" %>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="MainHeaderContent">
      ...
      <tr>
                            <td><asp:Image ID="Image8" runat="server" width="20px" Height="20px" imageurl="images/task.png" />&nbsp;Document Archived Per User Report</td>
                         </tr>
    </table>    
                                ...
                                <table border="0"  cellspacing="1" cellpadding="3" width="100%" style="border:solid 1px #D4D4D4;">
                                    ...
                                    <tr>
                                     ...
                                     <td align="right" width="150px"  class="labelFreeForm"  style="padding-left:10">
                                        ...
                                        <tr><td colspan="4"><uc:UserList id="ucList" runat="server" Visible="true"></uc:UserList></td>
