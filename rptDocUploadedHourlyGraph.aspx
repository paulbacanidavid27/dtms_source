<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Report.Master" CodeBehind="rptDocUploadedHourlyGraph.aspx.vb" Inherits="dms.rptDocUploadedHourlyGraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="rptDocUploadedHourlyGraph.rdlc">
            <DataSources>
