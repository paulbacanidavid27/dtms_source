<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UserControlPendingList.ascx.vb" Inherits="dms.UserControlPendingList" %>
...
<asp:Panel ID="pPendingList" runat="server" cssclass="bordertaskCrd">         
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" 
                                        style="background-color:#666633">
                            <tr height="25px" >
                                <td width="25px" style="border-bottom:solid 1px #D4D4D4;padding-left:4px;">
                                    
                                   
                                    <asp:HyperLink ID="hlPrint" runat="server" NavigateUrl="~/PendingApprovalList.aspx" Target="_blank"> <asp:Image ID="imgPrint" runat="server" ImageUrl="images/pending3.png" height="16px" Width="16px" ToolTip="Print List" /></asp:HyperLink>
                                </td>
                                <td align="left"  style="padding-top:5px;font-family:arial;font-weight:bold;font-size:14px;border-bottom:solid 1px #D4D4D4;color:#FFFFFF">                                    
                                    Documents With Pending Approval</td>                                    
                                 <td align="right" style="padding-top:5px;border-bottom:solid 1px #D4D4D4;color:white">
                  ...
                  <%--  </div> --%>     
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="margin-left:10px;border-collapse: collapse" width="98%">
                                <tr style="font-style:italic;border-bottom:solid 1px #222222;">
                                    ...
                                    <td style="padding-left:4px"><asp:LinkButton ID="lbSort4" runat="server" cssclass="sortcol" tooltip="Sort by Approver" OnClick="sortColumnHeader">Approver</asp:LinkButton><asp:Image ID="imgSort4" imageurl="images/asc.png" runat="server" visible="false"/></td>                                    
                                    <td>(Hard Copy)Received By/Date
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                        ...
                        <ItemTemplate>
                            ...
                            <tr  id="rowColorMain" runat="server" style="font-family: Arial; font-size: 8pt; color: #222222">
                                ...
                                <td valign="top"  style="padding-left:4px;width:auto">
                                    ...
                                    <asp:Literal ID="lSender" runat="server" text='<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "approvername"))%>'></asp:Literal>
                                </td>
                                <td valign="top"   width="20%" align="left" style="padding-left:1px;">
                                    
                                    <asp:Literal ID="lReceivedBy" runat="server" text='<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "ReceivedBy"))%>'></asp:Literal><asp:Literal ID="lReceivedDate" runat="server" text='<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "ReceivedDate"))%>'></asp:Literal>
                            ...
                            <tr>
                            <td colspan="6" style="padding-left:25px;margin-bottom:10px;">
                                <uc:UserControlDocRouting ID="ucDocRouting" runat="server" />
                            </td>
                            </tr>
                            <tr>
                               
                                <td colspan="6" style="padding-top:2px" align="right">
                                    <asp:Panel ID="pMsg" runat="server" Visible="false">
                                        ...
                                        <asp:Repeater ID="rptApprovalStatus" runat="server"  visible="false" OnItemDataBound="fDataBound">
                                            <HeaderTemplate>
                                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;font-family:tahoma;font-size:9pt;background-color:white;border:solid 1px #27468A;margin-left:1px;margin-right:1px;width:97%">
                                                <tr>
                                                <td colspan="4" class="tableheadersmall">Recipients List
                                                </td>
                                                </tr>
                                                    <tr>                                                        
                                                        <td  class="tableHead2">User Name</td>                                                        
                            ...
                            <tr>
                                <td colspan="6"><asp:panel ID="pcomment" runat="server" Visible="false"> Comment: 
