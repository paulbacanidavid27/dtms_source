<%@ Page Title="New Documents" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="newdocs.aspx.vb" Inherits="dms.newdocs" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainHeaderContent">
                ...
                <table border="0" width="100%">
                   <tr >
                        ...
                        <ContentTemplate>
                            <asp:ImageButton ID="imgInbox" runat="server" ImageUrl="images/doclist.png" ToolTip="Goto Inbox" height="20px" width="20px" style="vertical-align:middle"/>
                            &nbsp;Document List
                            </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>                 
    ...
    <!-- 01/17/2014 //-->                                                                        
     ...
     <table border="0" class="codetbl" cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse;z-index:900;border:#D4D4D4 solid 1px">
                    ...
                    <tr >
                        ...
                        <td class="newtblheader"><asp:LinkButton ID="lbSort4" runat="server" class="sortcol" tooltip="Sort by Point Person" OnClick="sortColumnHeader">Point Person</asp:LinkButton><asp:Image ID="imgSort4" imageurl="images/asc.png" runat="server" visible="false" style="vertical-align:middle;"/></td>
                        <td class="newtblheader"><asp:LinkButton ID="lbSort7" runat="server" class="sortcol" tooltip="Sort by Location" OnClick="sortColumnHeader">Location</asp:LinkButton><asp:Image ID="imgSort7" imageurl="images/asc.png" runat="server" visible="false" style="vertical-align:middle;"/></td>
    ...
    PopDelay="50" />
            ...
            <ItemTemplate>                
                    ...
                    <td class="tbldashed" valign="top" width="12px" align="left"  style="padding-top:3px;"><div  class="xxx"  style="width:200px"><asp:ImageButton ID="ImgUnbookmark" ToolTip='Remove your bookmark for this document' runat="server" imageUrl="images/bookmark_h.png" onmouseover="this.src='images/bookmark.png'" onmouseout="this.src='images/bookmark_h.png'"  Visible="false"/>
                        ...
                        <td class="tbldashed" valign="top" style="padding-top:3px;"><asp:Literal ID="ModifiedBy" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "firstapprover"))%>'></asp:Literal>
                        ...
                        <td class="tbldashed" valign="top" style="padding-top:3px;"><asp:Literal ID="lAgency" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "assignedto"))%>'></asp:Literal>
                        <%--<td class="tbldashed"><asp:Literal ID="Status" runat="server" Text='<%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "StatusDesc"))%>'></asp:Literal>                       --%>
                        </td>
        ...
        <asp:ListItem Selected="False" Text="ALL" Value="A" title="List all documents that you have access. This include all the documents received by your office." ></asp:ListItem>
         <asp:ListItem Selected="False" Text="INBOX" Value="I" title="List all documents that you already received and uploaded."></asp:ListItem>
          <asp:ListItem Selected="False" Text="SENT" Value="S" title="List all documents that you have routed to another user."></asp:ListItem>
           <asp:ListItem Selected="True" Text="NEW" Value="N" title="List all documents that you received for the day."></asp:ListItem>
    </asp:RadioButtonList>
</td>
