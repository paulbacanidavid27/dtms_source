...
Public Class UserControlPendingList
...
#End Region
    ...
    Public Sub RetrieveApproval()
        ...
        Try
            ...
            lsTotalRows = oApprove.CountPendingList
            If CInt(lsTotalRows) > 0 Then

                pPendingList.Visible = True
                oApprove.pSortCol = hfSortCol.Value
                oApprove.pSortOrder = hfSortOrder.Value
                ldata = oApprove.RetrievePendingList
    ...
    Private Sub Repeater2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater2.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If DirectCast(e.Item.FindControl("lReceivedBy"), Literal).Text.Trim <> "" AndAlso DirectCast(e.Item.FindControl("lReceivedDate"), Literal).Text.Trim <> "" Then
                DirectCast(e.Item.FindControl("lReceivedBy"), Literal).Text = DirectCast(e.Item.FindControl("lReceivedBy"), Literal).Text & " / "
            ElseIf DirectCast(e.Item.FindControl("lReceivedBy"), Literal).Text.Trim = "" AndAlso DirectCast(e.Item.FindControl("lReceivedDate"), Literal).Text.Trim = "" Then
                DirectCast(e.Item.FindControl("lReceivedBy"), Literal).Text = "[Not Yet]"
            End If
